                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Hi {{(!empty($details['name'])) ? $details['name'] : 'There'}}
                                                                    ,</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    It looks like you have chosen not to allow your
                                                                    athlete access to our <a
                                                                        href="https://puckrecruiter.com/">Puck
                                                                        Recruiter</a> App. We understand your concerns
                                                                    and join you in wanting to keep your athlete safe
                                                                    online. Rest assured, we have gone to great lengths
                                                                    to ensure the privacy and protection of our young
                                                                    athletes who have joined <a
                                                                        href="https://puckrecruiter.com/">Puck
                                                                        Recruiter</a>, including additional settings to
                                                                    enable extra layers of profile privacy.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    If you change your mind, simply have your athlete
                                                                    create a new account on our platform (with a
                                                                    different or same email) and we will send an
                                                                    additional request to you to enable them to get
                                                                    noticed and stay connected...all in one place.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>

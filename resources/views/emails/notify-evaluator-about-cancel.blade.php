                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <img
                                                                    src="{{asset('notify-guardian.jpeg')}}"
                                                                    alt
                                                        ...
                                                        <!--                                                                    <strong>Notify to Gurdian</strong></h1>-->
                                                        <!--                                                            </td>-->
                                                        <!--                                                        </tr>-->
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Hi&nbsp;{{$details['evaluator_first_name'].' '.$details['evaluator_last_name']}}
                                                                    ,</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    {{$details['player_first_name'].' '.$details['player_last_name']}}
                                                                    has been cancelled assessment request
                                                                    . So, That request has been removed from your
                                                                    accessment request list.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>

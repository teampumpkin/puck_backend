                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Dear {{(!empty($details['name'])) ? $details['name'] : 'user'}},</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    You made a great choice by ordering a <b>Puck
                                                                        Recruiter</b> evaluation! We have made sure that
                                                                    you are now in the queue to receive a comprehensive
                                                                    assessment report completed by a hockey
                                                                    professional. We know you will want to see it soon,
                                                                    so we make sure our turnaround time is 3-5 business
                                                                    days at the most.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    As soon as it is ready, we will touch base!
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>

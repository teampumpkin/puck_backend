                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Congratulations! You have been given consent by your
                                                                    parent or guardian to join the <a
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    We want you to be safe when you are using our app or
                                                                    website. Please follow these rules at <span
                                                                        style="text-decoration: underline;">all times</span>
                                                                    when online:
                                                                </p>
                                                                <ul style="color:#666666;">
                                                                    <li style="margin-top: 5px">Never give out personal
                                                                        information over chat including your email,
                                                                        phone number, or physical address.
                                                                    </li>
                                                                    <li style="margin-top: 5px">Never offer to meet up
                                                                        with anyone in real life who requests you do so
                                                                        when talking to them over chat.
                                                                    </li>
                                                                    <li style="margin-top: 5px">If someone makes you
                                                                        feel uncomfortable while chatting, go to their
                                                                        profile and choose ‘Block’ under the three dots
                                                                        menu.
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    We are always here to assist you at <a
                                                                        href="support@puckrecruiter.com">support@puckrecruiter.com</a>.
                                                                    If anyone is making you feel uncomfortable, please
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Okay, now that we have that covered, have fun!
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>

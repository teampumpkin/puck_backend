                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    We hear you forgot your password to log in to <a
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    No problem. Please enter the one-time code below
                                                                    (into the app) to reset your password and get you
                                                                    back in the action!
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr class="es-visible-simple-html-only"
                                                            ...
                                                            <td style="padding:15px;Margin:0">
                                                                <div class="otp-div"
                                                                     style="display:inline-block;color:#444444;border:1px solid #CCCCCC;border-radius:25px;background:green;box-shadow:0 0 5px -1px #CCCCCC;cursor:pointer;vertical-align:middle;max-width:100px;padding:10px;text-align:center;margin-left:40%">
                                                                    <label class="otp-label"
                                                                           style="color:white;font-weight:bolder;letter-spacing:5px;margin-left:10px">{{$details['otp']}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>

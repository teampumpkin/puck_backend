                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Hi {{$details['evaluator_name']}},</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    Thanks for requesting to become an evaluator for <a
                                                                        href="https://puckrecruiter.com/">Puck
                                                                        Recruiter</a>. Certainly, you can see the
                                                                    immense value that a <b>Puck Recruiter</b> evaluator
                                                                    can add to a player’s understanding and growth
                                                                    within the game.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    We have an extensive vetting process and look
                                                                    forward to filling you in regarding the next steps
                                                                    towards possibly becoming part of the <b>Puck
                                                                        Recruiter</b> family.
                                                                </p>
                                                            </td>
                                                        </tr>

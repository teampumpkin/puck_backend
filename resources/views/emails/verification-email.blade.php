                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse; margin-top: 10px">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    This email was recently used to register an account
                                                                    within the <a href="https://puckrecruiter.com/">Puck
                                                                        Recruiter</a> App. If this was you, great!
                                                        ...
                                                        <tr style="border-collapse:collapse; margin-top: 10px">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-right:35px;padding-left:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:left">
                                                                    If this was not you, please disregard this email and
                                                        ...
                                                        <tr style="border-collapse:collapse; margin-top: 10px">
                                                            <td align="left"
                                                                ...
                                                                <a class="btn btn-success"
                                                                   href="{{url(env('APP_DOMAIN', '').'/api/no-cache/verify-account').'/'.$details['token']}}"
                                                                   style="text-decoration: none;font-weight:bolder;display: inline-block;margin: 15px;padding: 2%;border-radius: 10px;background-color: red;background-image: linear-gradient(skyblue, blue); color: white">
                                                                    Yes! I want to confirm my email address.
                                                                </a>
                                                            </td>
                                                        </tr>
